...
public class CoffeShop {
	public static void main(String[] args) {
		...
		beverage[0] = new Coffee("Cappuccino", 3000);
		beverage[1] = new Coffee("CafeLatte", 2500);
		beverage[2] = new Tea("ginsengTea", 2000);
		beverage[3] = new Coffee("CafeLatte", 2500);
		beverage[4] = new Tea("redginsengTea", 2500);
	...
	public static void getSalesInfo(Beverage[] beverage){
		...
		for (Beverage beverage1 : beverage) {
			System.out.println(i + "번째 판매 음료는 " + beverage1.getName() + "이며, 가격은 " +beverage1.getPrice() + "\n");
			i++;
		}
	}
